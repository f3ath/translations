...
И вот тут ООП взлетел. Было написано множество<sup><a href="#4">4</a></sup> книг, расплодились бесчисленные<sup><a href="#5">5</a></sup> статьи. Так что теперь-то каждый может в объектно-ориентированное программирование, так?
...
- при дифференциальном программировании (автор использует термин differential programming, очевидно, им
...
<a id="2">2</a>. Системные и прикладные программисты приняли на вооружение C++ в середине 1980-х, но перед тем, как ООП стал общепринятым, прошел [еще десяток лет](https://en.wikipedia.org/wiki/Object-oriented_programming#History).
...
<a id="5">5</a>. Поиск в гугле по фразе "объектно-ориенрированное программирование" дает 8 млн результатов.

<a id="6">6</a>. Поиск в гугле выдает 37600 результатов по запросу "наследование это зло".

<a id="7">7</a>. Смысл (интерфейс) и механику (исполнение) можно разделить за счет усложнения языка. См. пример из спецификации [языка D](https://en.wikipedia.org/wiki/D_%28data_language_specification%29).
