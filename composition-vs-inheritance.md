...
- при дифференциальном программировании (автор использует термин differential programming, очевидно, понимая под ним нечто, отличное от [DDP](https://en.wikipedia.org/wiki/Differential_dynamic_programming) &mdash; прим. пер.)
