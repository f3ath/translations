...
Но вот лучик ООП воссиял над миром... Правда несколько десятилетий<sup><a href="#1">a</a></sup> никто этого не замечал. Покуда не появился графический интерфейс[^2], которому, как выяснилось, очень-очень не хватало ООП. Когда нажимаешь на кнопку в окне, что может быть проще, чем отправить кнопке (или ее представителю) сообщение "Нажатие"[^3] и получить результат?
