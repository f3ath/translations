...
<br>
<a id="7">7</a>. Смысл (интерфейс) и механику (исполнение) можно разделить за счет усложнения языка. См. пример из спецификации <a href="https://en.wikipedia.org/wiki/D_%28data_language_specification%29">языка</a>.
<br>
